...
${OBJECTDIR}/src/btree.o: src/btree.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/btree.o src/btree.cpp

${OBJECTDIR}/src/btreePage.o: src/btreePage.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/btreePage.o src/btreePage.cpp

${OBJECTDIR}/src/dataProxy.o: src/dataProxy.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dataProxy.o src/dataProxy.cpp

${OBJECTDIR}/src/diskFile.o: src/diskFile.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/diskFile.o src/diskFile.cpp
...
${OBJECTDIR}/src/pageRecord.o: src/pageRecord.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pageRecord.o src/pageRecord.cpp

${OBJECTDIR}/src/record.o: src/record.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/record.o src/record.cpp

${OBJECTDIR}/src/util.o: src/util.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/util.o src/util.cpp
...
${TESTDIR}/tests/BTreeFreshStartTests.o: tests/BTreeFreshStartTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BTreeFreshStartTests.o tests/BTreeFreshStartTests.cpp


${TESTDIR}/tests/btreefreshstartrunner.o: tests/btreefreshstartrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/btreefreshstartrunner.o tests/btreefreshstartrunner.cpp


${TESTDIR}/tests/BTreeLoadedTests.o: tests/BTreeLoadedTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BTreeLoadedTests.o tests/BTreeLoadedTests.cpp


${TESTDIR}/tests/btreeloadedrunner.o: tests/btreeloadedrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/btreeloadedrunner.o tests/btreeloadedrunner.cpp


${TESTDIR}/tests/BTreePageTests.o: tests/BTreePageTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BTreePageTests.o tests/BTreePageTests.cpp


${TESTDIR}/tests/btreepagerunner.o: tests/btreepagerunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/btreepagerunner.o tests/btreepagerunner.cpp


${TESTDIR}/tests/DataProxyTests.o: tests/DataProxyTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/DataProxyTests.o tests/DataProxyTests.cpp


${TESTDIR}/tests/dataproxyrunner.o: tests/dataproxyrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dataproxyrunner.o tests/dataproxyrunner.cpp


${TESTDIR}/tests/UtilitiesTests.o: tests/UtilitiesTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UtilitiesTests.o tests/UtilitiesTests.cpp


${TESTDIR}/tests/utilitiesrunner.o: tests/utilitiesrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/utilitiesrunner.o tests/utilitiesrunner.cpp
...
${OBJECTDIR}/src/btree_nomain.o: ${OBJECTDIR}/src/btree.o src/btree.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/btree_nomain.o src/btree.cpp;\
	else  \
...
${OBJECTDIR}/src/btreePage_nomain.o: ${OBJECTDIR}/src/btreePage.o src/btreePage.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/btreePage_nomain.o src/btreePage.cpp;\
	else  \
...
${OBJECTDIR}/src/dataProxy_nomain.o: ${OBJECTDIR}/src/dataProxy.o src/dataProxy.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dataProxy_nomain.o src/dataProxy.cpp;\
	else  \
...
${OBJECTDIR}/src/diskFile_nomain.o: ${OBJECTDIR}/src/diskFile.o src/diskFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/diskFile_nomain.o src/diskFile.cpp;\
	else  \
...
${OBJECTDIR}/src/pageRecord_nomain.o: ${OBJECTDIR}/src/pageRecord.o src/pageRecord.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pageRecord_nomain.o src/pageRecord.cpp;\
	else  \
...
${OBJECTDIR}/src/record_nomain.o: ${OBJECTDIR}/src/record.o src/record.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/record_nomain.o src/record.cpp;\
	else  \
...
${OBJECTDIR}/src/util_nomain.o: ${OBJECTDIR}/src/util.o src/util.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/util_nomain.o src/util.cpp;\
	else  \
